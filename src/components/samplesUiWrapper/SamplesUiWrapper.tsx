...
import styles from "./SamplesUiWrapper.module.css";
...
export default function SamplesUiWrapper({ sourceLink, children }: Props) {
    ...
    const profileHref = !isAuthPage && userId ? `/${userId}/profile` : null;
        ...
        <div className={styles.wrapper}>
            <div className={styles.header}>
                <a href="https://ravendb.net" target="_blank" rel="noreferrer">
                    <img
                        src="https://ravendb.github.io/samples-ui-wrapper/assets/ravendb-logo.svg"
                        alt="RavenDB"
                ...
                {!isAuthPage && (
                    <nav className={styles.headerNav}>
                        {profileHref && (
                            <Link href={profileHref} className={`${styles.headerNavLink} ${pathname.endsWith("/profile") ? styles.headerNavLinkActive : ""}`}>
                                Profile
                            </Link>
                        )}
                ...
                <a className={styles.badgeLink} href={sourceLink} target="_blank" rel="noreferrer">
            ...
            {toastVisible && (
                <div className={styles.welcomeToast}>
                    <div className={styles.welcomeToastContent}>
                        <div className={styles.welcomeToastClose} onClick={() => setToastVisible(false)}>
            ...
            <div className={styles.footer}>
                <div className={styles.resources} style={{ display: resourcesVisible ? "flex" : "none" }}>
                    <a className={styles.badgeLink} href="https://docs.ravendb.net" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 12 12">
                    ...
                    <a className={styles.badgeLink} href="https://ravendb.net/community" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 12 12">
                ...
                <div className={styles.poweredBy}>
                    <span>
                        Powered by{" "}
                        <a href="https://ravendb.net" className={styles.ravendbLink} target="_blank" rel="noreferrer">
                            RavenDB
                        </a>
                    </span>
                    <div className={styles.toggleResources}>
                        <div
                            className={styles.hideResources}
                            onClick={() => setResourcesVisible(false)}
                            style={{ display: resourcesVisible ? "flex" : "none" }}
                        >
                            Hide
                            <svg width="9" height="6" viewBox="0 0 9 6" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                <path d="M8.63049 1.61304L4.64905 5.60815L0.669556 1.62866L1.49084 0.807373L4.651 3.9519L7.8092 0.791748L8.63049 1.61304Z" />
                            </svg>
                        </div>
                        <div
                            className={styles.showResources}
                            onClick={() => setResourcesVisible(true)}
                            style={{ display: resourcesVisible ? "none" : "flex" }}
                        >
                            Show
                            <svg width="9" height="6" viewBox="0 0 9 6" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
